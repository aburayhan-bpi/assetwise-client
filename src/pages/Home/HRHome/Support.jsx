...
const Support = () => {
  return (
    <div className="p-8 bg-white dark:bg-transparent rounded-2xl mt-14 text-center">
      <h2 className="text-center text-3xl font-bold text-gray-800 dark:text-white mb-4">
        Support & Contact
      </h2>
      <p className="text-center text-lg text-gray-600 dark:text-white/80 mb-6">
        Need help? Get in touch with our HR support team.
      </p>
      <div className="space-y-4 text-gray-700 text-lg">
        <p className="flex items-center justify-center gap-2 dark:text-white/80">
