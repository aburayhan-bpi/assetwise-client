...
const AddEmployee = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-8 space-y-12">
      ...
      {/* Package Section */}
      <div className="bg-gradient-to-r from-blue-500 to-indigo-500 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-700 text-white p-8 rounded-lg shadow-lg space-y-6">
        <div className="flex justify-between items-center">
          ...
          {currentUser?.limit >= 20 ? (
            ...
            <Link to="/increase-limit">
              <button className="bg-white text-blue-600 dark:bg-gray-800 dark:text-yellow-400 outline font-semibold px-5 py-3 rounded-lg shadow hover:bg-gray-100 transition">
                Increase Limit
              </button>
            </Link>
          )}
        ...
        <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 justify-center items-center gap-6 mb-8">
            {employees.map((emp) => (
              <div
                key={emp?._id}
                className="flex flex-col lg:flex-row items-center p-4 bg-gray-50 dark:bg-gray-300 w-full dark:border-none border rounded-lg shadow-sm hover:shadow-md transition"
              >
                <input
                  ...
                  type="checkbox"
                  className="checkbox checkbox-md mr-3 mb-3 lg:mb-0"
                />
                <img
